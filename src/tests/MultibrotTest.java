...
public class MultibrotTest {
	...
	public void maxEscapeTime() {
		...
		int[][] testGrid = _canvas.multibrotEscapes(2.0,255,-2.15,.6,-1.3,1.3);
	...
	public void correctLength() {
		_canvas = new PixelMatrix(512,512);
		int[][] multibrotPaint = _canvas.multibrotEscapes(2.0,255,-2.15,.6,-1.3,1.3);
		assertEquals(multibrotPaint.length,512);
	}
	...
	public void correctWidth() {
		_canvas = new PixelMatrix(512,512);
		int[][] multibrotPaint = _canvas.multibrotEscapes(2.0,255,-2.15,.6,-1.3,1.3);
		assertEquals(multibrotPaint[0].length,512);
	}
	...
	public void pixelCoordinateTranslation() {
		...
		int passes = 0;
		_canvas = new PixelMatrix(512,512);
		int[][] constant = _canvas.multibrotEscapes(2,255,-2.15,.6,-1.3,1.3);
