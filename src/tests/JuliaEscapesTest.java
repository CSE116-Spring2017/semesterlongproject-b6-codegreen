...
public class JuliaEscapesTest {
	...
	public void correctLength() {
		_canvas = new PixelMatrix(512,512);
		int[][] juliaPaint = _canvas.juliaEscapes(2.0,255,-2.15,.6,-1.3,1.3);
		assertEquals(juliaPaint.length,512);
	}
	...
	public void correctWidth() {
		_canvas = new PixelMatrix(512,512);
		int[][] juliaPaint = _canvas.juliaEscapes(2.0,255,-2.15,.6,-1.3,1.3);
		assertEquals(juliaPaint[0].length,512);
	}
	...
	public void pixelCoordinateTranslation() {
		...
		int passes = 0;
		_canvas = new PixelMatrix(512,512);
		int[][] constant = _canvas.juliaEscapes(2,255,-2.15,.6,-1.3,1.3);
